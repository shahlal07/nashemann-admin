  ...
  return (
    <div>
      ...
      <StaggerGroup className="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4">
        <StaggerItem>
          <StatCard label="Active vendors" value={stats.activeVendors} icon={Store} href="/vendors" />
        </StaggerItem>
        <StaggerItem>
          <StatCard
        ...
        <StaggerItem>
          <StatCard label="Orders (30d)" value={stats.totalOrders30d} icon={ShoppingBag} href="/vendors" />
        </StaggerItem>
        <StaggerItem>
          <StatCard
